...
页面支持上传 PDF、选择转换配置、选择答案展示方式、选择答案页位置、选择清爽排版或贴近原文位置排版，并下载生成的 PPTX。转换前可执行预检查，查看答案页、题目数、答案数、匹配数、未匹配题目和未使用答案。转换任务会在后台执行，任务页会自动刷新状态。
...
- Web 支持预检查，生成前展示答案映射数量、置信度、未匹配题目和未使用答案。
